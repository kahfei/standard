...
const char * LIB_PATH_VALUE   = "d:\\exercise\\number_backup\\sqlite_autoconf\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "d:\\exercise\\number_backup\\sqlite_autoconf\\.libs;D:\\exercise\\number_backup\\sqlite_autoconf\\local\\lib;D:\\exercise\\number_backup\\sqlite_autoconf\\local\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    PATH=/d/exercise/number_backup/sqlite_autoconf/.libs:/usr/local/lib:/usr/lo", f);
  fputs ("cal/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/d/exercise/number_backup/sqlite_autoconf/.libs:$PATH\"\n", f);
  fputs ("\n", f);
